...
import { Building2, MapPin, ImageIcon, Users, GraduationCap, Expand} from "lucide-react";
...
export function CampusSettingsOverviewCard({ campus, addressLabel }: CampusSettingsOverviewCardProps) {
                ...
                <div className="space-y-4">
                        ...
                        <>
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        {campus.metrics.activeStudents} active / {campus.metrics.totalStudents} total
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        {campus.metrics.activeStaff} active / {campus.metrics.totalStaff} total
                                    </p>
                                </div>
                            </div>
                        </>
                    ...
                    {campus.availableGrades && campus.availableGrades.length > 0 && (
                        <div className="flex items-start gap-3">
                            <GraduationCap className="h-4 w-4 text-primary mt-0.5" />
                            <div className="flex-1">
                                <p className="text-sm font-medium text-foreground">Available Grades</p>
